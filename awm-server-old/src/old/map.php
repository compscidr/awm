  ...
  <script>
      ...
      function initMap() {
        map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 37.5457778, lng: -122.2540339},
          zoom: 14
        });
      ...
      <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo MAPS_KEY; ?>&callback=initMap&libraries=visualization" async defer></script>
    </body>
</html>
<?
$mysqli->close();
